...
import com.peels.ucenterService.utils.ConstantWxUtils;
import com.peels.ucenterService.utils.HttpClientUtils;
...
//        return "redirect:"+url;
    ...
    public String callback(String code, String state) {
        ...
        try {
            ...
            stringRedisTemplate.opsForHash().put(RedisConstants.MEMBER_TOKEN+jwtToken,"memberId",member.getId());
            stringRedisTemplate.opsForHash().put(RedisConstants.MEMBER_TOKEN+jwtToken,"nickName",member.getNickname());
            stringRedisTemplate.expire(RedisConstants.MEMBER_TOKEN+jwtToken,1000*60*60*30,TimeUnit.MILLISECONDS);
