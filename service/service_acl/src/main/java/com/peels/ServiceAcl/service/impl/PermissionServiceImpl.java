...
import com.peels.ServiceAcl.entity.RolePermission;
import com.peels.ServiceAcl.entity.User;
import com.peels.ServiceAcl.entity.dto.AssignDto;
import com.peels.ServiceAcl.helper.MenuHelper;
import com.peels.ServiceAcl.helper.PermissionHelper;
import com.peels.ServiceAcl.mapper.PermissionMapper;
import com.peels.ServiceAcl.service.PermissionService;
import com.peels.ServiceAcl.service.RolePermissionService;
...
import static com.peels.ServiceAcl.helper.PermissionHelper.List2Tree;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission> implements PermissionService {
    ...
    public List<Permission> queryAllMenu() {
        ...
        return buildTreePermissionList(permissionList);
    }

    private List<Permission> buildTreePermissionList(List<Permission> permissionList) {
    ...
    private List<Permission> getChildren(Permission item, List<Permission> permissionList,Integer level) {
    ...
    public List<Permission> selectAllMenu(String roleId) {
        ...
        List<Permission> permissionList = List2Tree(allPermissionList);
    ...
    public List<JSONObject> selectPermissionByUserId(String userId) {
        ...
        List<Permission> permissionList = PermissionHelper.List2Tree(selectPermissionList);

        return MenuHelper.buildRoutes(permissionList);
    }
    ...
    public void removeChild(String id) {
        ...
        List<String> collect = list.stream().map(Permission::getId).collect(Collectors.toList());
        list.forEach(item -> removeChild(item.getId()));
        if(collect.isEmpty()) return;
        baseMapper.deleteBatchIds(collect);
    }

    @Override
    public void assignRolePermissions(AssignDto assignDto) {
        List<RolePermission>list = new ArrayList<>();
        for (String s : assignDto.getPermissionId()) {
            RolePermission rolePermission = new RolePermission();
